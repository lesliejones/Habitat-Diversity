...
write.csv(pcout, file="C:/Habitat_Diversity/Analysis/Data/PCout_chinook.csv")
...
library(car)
vif(lm(chinook_hab ~ slope_avgW + slope_cvW + elev_cvW + forest + shrub + wetland + ccomplexity + sinuosity +
         flood_elev + glacierA + elev_avgS + elev_cvS + slope_avgS + slope_cvS, data=chinooksub))

#remove slope_cvW
vif(lm(chinook_hab ~ slope_avgW  + elev_cvW + forest + shrub + wetland + ccomplexity + sinuosity +
         flood_elev + glacierA + elev_avgS + elev_cvS + slope_avgS + slope_cvS, data=chinooksub))
#remove elev_avgS
vif(lm(chinook_hab ~ slope_avgW  + elev_cvW + forest + shrub + wetland + ccomplexity + sinuosity +
         flood_elev + glacierA + elev_cvS + slope_avgS + slope_cvS, data=chinooksub))

library(lme4)
fitchinook2 <- lmer(chinook_hab ~ slope_avgW  + elev_cvW + forest + shrub + wetland + ccomplexity + sinuosity +
         flood_elev + glacierA + elev_cvS + slope_avgS + slope_cvS + (1|region), data=chinooksub)
summary(fitchinook2)

# Get R2 for linear mixed effects model (lme4)
library(piecewiseSEM)
r2chinook <- rsquared(lme4::lmer(chinook_hab ~ slope_avgW  + elev_cvW + forest + shrub + wetland + ccomplexity + sinuosity +
         flood_elev + glacierA + elev_cvS + slope_avgS + slope_cvS + (1|region), data=chinooksub))
