...
#Phabm2 <- Phabm %>% filter(region %in% c("Southeast","Bristol Bay","Yukon", "Kuskokwim","Cook Inlet"))
fviz_pca_biplot(res.pca, col.var="light grey", pointsize=3, geom.ind = "point", axes = c(1,2), repel = TRUE, habillage = Phabm$region, addEllipses = FALSE, palette = c(rep("white",2), "#F8766D", "white", "#B79F00", rep("white",3), "#00BA38", "white", "white", "#00BFC4",
"#619CFF"))
...
fviz_pca_biplot(res.pca, geom.ind = "point", axes = c(1,2), repel = TRUE, habillage = Phabm$region, addEllipses = TRUE, palette = c("#F564E3", "white", "#619CFF", "white", "#F8766D", "white", "#B79F00", rep("white",6)))

#fviz_pca_biplot(res.pca, geom.ind = "point", axes = c(1,2), repel = TRUE, habillage = Phabm$region, addEllipses = FALSE, palette #= c("#F564E3", "white", "#619CFF", "white", "#F8766D", "white", "#B79F00", rep("white",6)))
