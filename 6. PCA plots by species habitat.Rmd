...
x2 <- Phab3 %>% pull(coho_hab) %>%replace_na(0)
x2 [x2>0] <- 1 
#View(x2)
...
fviz_pca_biplot(res.pca, col.var="slategray3", pointsize=x31, geom.ind = "point", axes = c(1,2), repel = TRUE, habillage = x2, addEllipses = FALSE)
