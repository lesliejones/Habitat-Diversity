...
Phabm<-scale(Phab0, scale=TRUE, center=TRUE)
#View(Phabm)
...
pcout <- cbind(Phab33$region, Phab33$id_numeric, Phab33$pink_hab, Phab33$coho_hab, Phab33$sockeye_hab, 
               Phab33$coho_hab, Phab33$chum_hab,pcscores)
...
fviz_pca_biplot(res.pca, geom.ind = "point", axes = c(1,2), 
                ...
                palette = c( "white", "#F8766D", rep("white",5),"#619CFF", "#00BFC4", rep("white",3), "#00BA38"))
