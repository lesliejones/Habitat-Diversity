...
# second mondel
fit2 <- lm(chinook_hab ~   ccomplexity + sinuosity +  lake_elev +  elev_cvS + slope_avgS +
            slope_cvS  +  forest + shrub, data = chinook)

summary (fit2)


vif(lm(chinook_hab ~  ccomplexity + sinuosity +  lake_elev +  elev_cvS + slope_avgS +
            slope_cvS  + forest + shrub , data = chinook))
...
vif(lm(sockeye_hab ~ slope_avgW + elev_avgW + wetland + ccomplexity + sinuosity + flood_elev + lake_elev + elev_avgS + elev_cvS + slope_avgS + slope_cvS + slope_cvW + glacierA + floodplainA + lakeD + forest + shrub , data = sock))


fits2 <- lm(sockeye_hab ~ slope_avgW + elev_avgW + wetland + ccomplexity + sinuosity + flood_elev + lake_elev + elev_avgS + elev_cvS + slope_avgS + slope_cvS + slope_cvW + glacierA + floodplainA + lakeD + forest + shrub , data = sock)
