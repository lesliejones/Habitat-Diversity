...
chum <- read_csv("C:/Habitat_Diversity/Analysis/Data/stream_indicators/chum_stream_indicators.csv")
Phab <- left_join(Phab, chum, by="id_numeric")
dim(Phab)
View(Phab)
...
write.csv(pcout, file="C:/Habitat_Diversity/Analysis/Data/O2_chum_PCout.csv")
...
chum_pred <- predict(fitchum2, Phab3, allow.new.levels=TRUE)
View(chum_pred)
chum_out <- cbind(Phab3,chum_pred) 
View(chum_out)
chum_out$chum_pred2=(chum_out$chum_pred*100)
chum_out$chum_hab2 = (chum_out$chum_hab*100)
chum_out$chum_diff = (chum_out$chum_hab - chum_out$chum_pred)
View(chum_out)
chum_out2 <- chum_out

ggplot(chum_out2, aes(x=chum_pred, y=chum_hab)) + geom_point()

#export this and join with watersheds in arcgis
write.csv(chum_out2, file="C:/Habitat_Diversity/Analysis/Data/pred_chum.csv")
```
