...
fviz_pca_biplot(res.pca, col.var="slategray3", pointsize=3, geom.ind = "point", axes = c(1,2), repel = TRUE, habillage = Phabm$region, addEllipses = FALSE, palette = c(rep("white",2), "red2", "white", "red2", rep("white",3), "red2", "white", "white", "red2","red2"))
...
fviz_pca_biplot(res.pca, col.var="slategray3", pointsize=3, geom.ind = "point", axes = c(1,2), repel = TRUE, habillage = Phabm$region, addEllipses = FALSE, palette = c("red2", "white", "red2", "white", "red2", "white", "red2", rep("white",6)))
...
#select ellipsoids
# SE, Yukon, PWS
fviz_pca_biplot(res.pca, col.var="slategray3", pointsize=3, geom.ind = "point", axes = c(1,2), repel = TRUE, habillage = Phabm$region, addEllipses = FALSE, palette = c(rep("white", 10), "red2", "red2", "red2"))
...
```{r}
fviz_pca_biplot(res.pca, col.var="slategray3", pointsize=3, geom.ind = "point", axes = c(1,2), repel = TRUE, habillage = Phabm$region, addEllipses = FALSE, palette = c(rep("white", 6), "red2", rep("white", 3),"red2", "red2", "white"))
...
fviz_pca_biplot(res.pca, col.var="slategray3", pointsize=3, geom.ind = "point", axes = c(1,2), repel = TRUE, habillage = Phabm$region, addEllipses = FALSE, palette = c(rep("white", 4), rep("red2", 3), rep("white", 4),"red2", "white"))
